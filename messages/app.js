...
module.exports = {
  ...
  completed: function () {
    return [
      ...
      '\n',
      TerminalUtils.list(null, '1.'), 'Run ', chalk.cyan('grunt'), ' to serve the app at ' ,
      chalk.bold(this.serverBaseHttpUrl()),
      '\n',
      TerminalUtils.list(null, ' '),
      chalk.grey('(Ensure that you have previously installed grunt using `npm install -g grunt-cli`)'),
      '\n',
      '\n',
