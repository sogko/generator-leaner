...
module.exports = {
  ...
  completed: function () {
    var defaultConfig = require(Paths(this).dest.server.config);
    return [
      '\n',
      '\n',
      ...
      chalk.bold(Paths(this).serverBaseHttpUrl()),
      '\n',
      '\n',
  ...
  generateProjectRoot: function () {
    return [
      ...
      chalk.bold(Paths(this).dest.root),
      '\n'
    ].join('');
  },
  generateServerComponents: function () {
    return [
      ...
      chalk.bold(Paths(this).dest.server.root),
      '\n'
    ].join('');
  },
  generateClientComponents: function () {
    return [
      ...
      chalk.bold(Paths(this).dest.client.root),
      '\n'
    ].join('');
  },
